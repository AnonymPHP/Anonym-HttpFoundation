<?php
    /**
     * Bu sınıf AnonymFramework'un bir parçasıdır, Http ile ilgili bir çok işlem buradan gerçekleştirilir.
     *
    ...
    class Request extends ServerBag
    {
        ...
        public function user()
        {
            ...
            return Singleton::make('\Anonym\Components\HttpClient\UserManager', []);
        }
