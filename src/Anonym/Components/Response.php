<?php
    ...
    use Anonym\Cookie;
    use Anonym\Components\HttpClient\Response\ShouldBeResponse;
    use Anonym\Patterns\Singleton;
    use Anonym\Twig;
    use Anonym\View;
    use Anonym\View\ShouldBeView;
    use Anonym\Components\HttpClient\Response\HttpResponseException;
    ...
    class Response implements ShouldBeResponse
    {
        ...
        public function __construct($content = '', $statusCode = 200)
        {
            ...
            $this->headersBag = Singleton::make('Anonym\Components\HttpClient\Response\HeadersBag');
